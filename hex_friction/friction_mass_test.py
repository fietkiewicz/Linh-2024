...
<mujoco model="Boxes">
    ...
    <worldbody>
        ...
        <site name="end" size="0.01" pos=".5 .2 .05"></site>
        ...
        <body pos="0 .2 .1">
            ...
            <site name="start" size="0.01"></site>
        </body>
    </worldbody>

    <tendon>
        <spatial name="cube_tendon_cube" width="0.005">
            <site site="start"></site>
            <site site="end"></site>
        </spatial>
    </tendon>
    ...
    <actuator>
        <muscle name="muscle" tendon="cube_tendon_cube"/>
    </actuator>
