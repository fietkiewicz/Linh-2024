"""
Uses hex3.xml
Usage: python hex3.py
  or
Usage: python hex3.py hex1.txt
"""
...
def init_and_run():
    ...
    viewer.cam.trackbodyid = 7 # this is torso id
...
def load_setting(filename = ""):
    ...
    start_1.insert(0, float(save[16].strip()))
    start_2.insert(0, float(save[17].strip()))
    speed.insert(0, round(float(save[18].strip())))
    angle_1.insert(0, float(save[19].strip()))
    angle_2.insert(0, float(save[20].strip()))
    angle_3.insert(0, float(save[21].strip()))
    angle_4.insert(0, float(save[22].strip()))
    angle_5.insert(0, float(save[23].strip()))
    angle_6.insert(0, float(save[24].strip()))
    angle_7.insert(0, float(save[25].strip()))
    angle_8.insert(0, float(save[26].strip()))
    start_phrase.insert(0, round(float(save[27].strip())))
...
ctr1_5.grid(row=2, column=0, pady=2, padx = 5)
ctr1_6 = Entry(window, width = 7)
ctr1_6.grid(row=2, column=1, pady=2, padx = 5)
ctr1_7 = Entry(window, width = 7)
ctr1_7.grid(row=2, column=2, pady=2, padx = 5)
ctr1_8 = Entry(window, width = 7)
ctr1_8.grid(row=2, column=3, pady=2, padx = 5)

ctrl2_label = Label(window, text = "Second Controler Amplitude").grid(row=3, column=0, columnspan=4, pady=2)
ctr2_1 = Entry(window, width = 7)
ctr2_1.grid(row=4, column=0, pady=2, padx = 5)
ctr2_2 = Entry(window, width = 7)
ctr2_2.grid(row=4, column=1, pady=2, padx = 5)
ctr2_3 = Entry(window, width = 7)
ctr2_3.grid(row=4, column=2, pady=2, padx = 5)
ctr2_4 = Entry(window, width = 7)
ctr2_4.grid(row=4, column=3, pady=2, padx = 5)
ctr2_5 = Entry(window, width = 7)
ctr2_5.grid(row=5, column=0, pady=2, padx = 5)
ctr2_6 = Entry(window, width = 7)
ctr2_6.grid(row=5, column=1, pady=2, padx = 5)
ctr2_7 = Entry(window, width = 7)
ctr2_7.grid(row=5, column=2, pady=2, padx = 5)
ctr2_8 = Entry(window, width = 7)
ctr2_8.grid(row=5, column=3, pady=2, padx = 5)

start_label = Label(window, text = "Starting Forces").grid(row=6, column=0, columnspan=2, pady=2)
start_1 = Entry(window, width = 7)
start_1.grid(row=7, column=0, padx=5, pady=2)
start_2 = Entry(window, width = 7)
start_2.grid(row=7, column=1, padx=5, pady=2)

speed_label = Label(window, text = "Speed").grid(row=6, column=3, pady=2)
speed = Entry(window, width = 7)
speed.grid(row=7, column=3, padx=5, pady=2)

angle_label = Label(window, text = "Angle Phase").grid(row=8, column=0, columnspan=4, pady=2)
angle_1 = Entry(window, width = 7)
angle_1.grid(row=9, column=0, pady=2, padx = 5)
angle_2 = Entry(window, width = 7)
angle_2.grid(row=9, column=1, pady=2, padx = 5)
angle_3 = Entry(window, width = 7)
angle_3.grid(row=9, column=2, pady=2, padx = 5)
angle_4 = Entry(window, width = 7)
angle_4.grid(row=9, column=3, pady=2, padx = 5)

angle_label = Label(window, text = "Angle Phase (left)").grid(row=10, column=0, columnspan=4, pady=2)
angle_5 = Entry(window, width = 7)
angle_5.grid(row=11, column=0, pady=2, padx = 5)
angle_6 = Entry(window, width = 7)
angle_6.grid(row=11, column=1, pady=2, padx = 5)
angle_7 = Entry(window, width = 7)
angle_7.grid(row=11, column=2, pady=2, padx = 5)
angle_8 = Entry(window, width = 7)
angle_8.grid(row=11, column=3, pady=2, padx = 5)

start_phrase_label = Label(window, text="Starting Phrase").grid(row=12, column=0, columnspan=3, pady=2)
start_phrase = Entry(window, width = 7)
start_phrase.grid(row=12, column=3, pady=2, padx=2)


init_btn = Button(window, text="Init and Run", width=30, command=init_and_run).grid(row=13,column=0, columnspan=4, pady=2)
save_btn = Button(window, text="Save", width=12, command=save_setting).grid(row=14, column=0, columnspan=2, padx=5, pady=2)
load_btn = Button(window, text="Load", width=12, command=load_setting).grid(row=14, column=2, columnspan=2, padx=5, pady=2)
