...
def init_and_run():
    ...
    hip_extensor = [0, 0.3, 0.1, 0, 0.1, 0.1, 0, 0]
    hip_flexor = [0.3, 0.3, 0.2, 0, 0, 0, 0, 0]
    ankle_flexor = [0, 0.1, 0, 0, 0, 0.1, 0.1, 0]
    knee_extensor = [0, 0, 1, 1, 0, 0, 0, 0]
    # knee_flexor = [0, 0, 0, 0.01, 0.03, 0]
    ...
    while viewer.is_alive and i < N:
        ...
        data.ctrl[2] = knee_extensor[phase]
        ...
        data.ctrl[8] = knee_extensor[(phase + 4) % 8]
        # data.ctrl[9] = knee_flexor[(phase + 3) % 6]
